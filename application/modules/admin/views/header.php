                    ...
                    <?php if ($this->session->userdata('is_admin')) : ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownAdminConfig">
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('admin/ver_comentarios'); ?>">
                                        <i class="bi bi-chat-left-text me-1"></i> Ver Comentarios
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('admin/cargasvirtuales/list/'.date('Y-m-d')); ?>">
                                        <i class="bi bi-cloud-upload me-1"></i> Ver Cargas Virtuales
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('admin/crear_vendedor'); ?>">
                                        <i class="bi bi-person-fill-add me-1"></i> Nuevo Vendedor
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('admin/csv_carga'); ?>">
                                        <i class="bi bi-filetype-csv me-1"></i> Cargar desde CSV
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownSettings">
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('admin/configuracion/periodos'); ?>">
                                        <i class="bi bi-calendar-range me-1"></i> Periodos de funcionamiento
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('admin/configuracion/feriados_list/'.date('Y')); ?>">
                                        <i class="bi bi-calendar-x me-1"></i> Feriados
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?= base_url('admin/configuracion/links'); ?>">
                                        <i class="bi bi-link-45deg me-1"></i> Botones de Pagos
                                    </a>
                                </li>
                                <li>
